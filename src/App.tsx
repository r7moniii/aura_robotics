...
function App() {
  ...
  return (
    <div className="bg-[#141414] text-white font-sans">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-32">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-left">
          ...
          <button
            ...
            className="group inline-flex items-center space-x-3 bg-[#9f64cb] hover:bg-[#8b4fb8] px-8 py-4 rounded-full transition-all duration-200 transform hover:scale-105"
          >
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-20 left-20 w-32 h-32 border border-[#9f64cb] rounded-full animate-pulse"></div>
          <div className="absolute bottom-40 right-32 w-24 h-24 border border-[#9f64cb] rounded-lg rotate-45 animate-bounce"></div>
          <div className="absolute top-1/2 left-1/3 w-16 h-16 bg-[#9f64cb] rounded-full animate-ping"></div>
        </div>
      </section>
      ...
      {/* About Us Section */}
      <section id="about" className="py-20 lg:py-32 bg-gradient-to-b from-transparent to-[#9f64cb]/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-left mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                <Trophy className="h-8 w-8 text-[#9f64cb] mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-2xl font-semibold mb-3">Rising Innovators</h3>
              ...
              <div className="flex items-start space-x-4">
                <Target className="h-8 w-8 text-[#9f64cb] mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-2xl font-semibold mb-3">Technology Vision</h3>
                  <p className="text-gray-300 leading-relaxed">
              ...
              <div className="flex items-start space-x-4">
                <Users className="h-8 w-8 text-[#9f64cb] mt-1 flex-shrink-0" />
                <div>
                  <h3 className="text-2xl font-semibold mb-3">National Ambition</h3>
                  <p className="text-gray-300 leading-relaxed">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#9f64cb]/20 to-transparent rounded-2xl p-8 border border-[#9f64cb]/20">
                <h3 className="text-2xl font-semibold mb-6 text-[#9f64cb]">Our Mission</h3>
                ...
                <div className="mt-6 pt-6 border-t border-[#9f64cb]/20">
